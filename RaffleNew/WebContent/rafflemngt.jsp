	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Raffle management</h1>
					</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="row">
										<form action="AddRaffleServlet" method="post">
											<div class="col-lg-6">
												<div class="form-group">
													<label>Raffle campaign name</label> <input
														class="form-control" type="text" name="cmp_name">
													<p class="help-block">Add name for your raffle
														campaign.</p>
												</div>
												<div class="form-group">
										...
										<div class="col-lg-6">
											<label>Preview image for all the raffle</label>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-lg-6">
											<form role="form">
												<div class="form-group">
													<label>Available raffles</label>&nbsp;&nbsp;|&nbsp;&nbsp;<small>Select
										...
										<div class="col-lg-6">
											...
											<div class="row">
												...
												<div class="col-lg-5">
													<label>Maximum prize limit</label>
													<div class="form-group input-group">
														<input type="text" class="form-control"> <span
															class="input-group-addon">.00</span>
													</div>
											...
											<div class="row">
												...
												<div class="col-lg-5">
													<form role="form">
														<div class="form-group">
															<label>Ends on</label> <input class="form-control"
																type="date">
														</div>
													</form>
												</div>
